 ...
 * @api
 */
class Tx_CalendarDisplay_ViewHelpers_Widget_PaginateViewHelper extends Tx_Fluid_Core_Widget_AbstractWidgetViewHelper {

	/**
	 * @var Tx_CalendarDisplay_ViewHelpers_Widget_Controller_PaginateController
	 */
	protected $controller;

	/**
	 * @param Tx_CalendarDisplay_ViewHelpers_Widget_Controller_PaginateController $controller
	 * @return void
	 */
	public function injectController(Tx_CalendarDisplay_ViewHelpers_Widget_Controller_PaginateController $controller) {
