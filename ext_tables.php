...
t3lib_extMgm::addLLrefForTCAdescr('tx_calendardisplay_domain_model_itembooking', 'EXT:calendar_display/Resources/Private/Language/locallang_csh_tx_calendardisplay_domain_model_itembooking.xml');
t3lib_extMgm::allowTableOnStandardPages('tx_calendardisplay_domain_model_itembooking');
$TCA['tx_calendardisplay_domain_model_itembooking'] = array (
	'ctrl' => array (
		'title'             => 'LLL:EXT:calendar_display/Resources/Private/Language/locallang_db.xml:tx_calendardisplay_domain_model_itembooking',
		'label' 			=> 'resource',
		'tstamp' 			=> 'tstamp',
		'crdate' 			=> 'crdate',
		'versioningWS' 		=> 2,
		...
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY) . 'Configuration/TCA/Itembooking.php',
		'iconfile' 			=> t3lib_extMgm::extRelPath($_EXTKEY) . 'Resources/Public/Icons/tx_calendardisplay_domain_model_booking.gif'
	)
);
